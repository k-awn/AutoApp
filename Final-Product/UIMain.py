...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Workflow1Name.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">" + data['Workflow1Name'] + "</span></p></body></html>", None))
        self.Workflow2Name.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p><span style=\" font-size:12pt;\">" + data['Workflow2Name'] + "</span></p></body></html>", None))

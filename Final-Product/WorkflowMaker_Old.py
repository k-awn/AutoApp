...
class Ui_MainWindow2(object):
    def setupUi(self, MainWindow):
        ...
        self.label_13 = QLabel(self.pressKeySettings)
        self.label_13.setObjectName(u"label_13")

        self.gridLayout_11.addWidget(self.label_13, 1, 0, 1, 1)

        self.amountInput = QPlainTextEdit(self.pressKeySettings)
        self.amountInput.setObjectName(u"amountInput")
        self.amountInput.setMaximumSize(QSize(16777215, 25))
        self.amountInput.setStyleSheet(u"background:transparent; border:none;")

        self.gridLayout_11.addWidget(self.amountInput, 1, 1, 1, 1)
        ...
        def AddFunction():
            ...
            if funcIndex == '8':
                orderedMethod[count] = {'type': 'Open New Window'}
                additionalContent = ('')
            if funcIndex == '9':
                orderedMethod[count] = {'type': 'Close Window'}
                additionalContent = ('')
            if funcIndex == '10':
                orderedMethod[count] = {'type': 'Next Window'}
                additionalContent = ('')
            if funcIndex == '11':
                orderedMethod[count] = {'type': 'Previous Window'}
                additionalContent = ('')
            if funcIndex == '12':
        ...
        def Compile():
            ...
            if values > 1:
                for i in range(values-1):
                    ...
                    elif orderedMethod[realnum]['type'] == 'Open New Window':
                        writeText.write('with pyautogui.hold(["win", "ctrl"]): \n\t\tpyautogui.press("d")') #! untested)
                    elif orderedMethod[realnum]['type'] == 'Close Window':
                        writeText.write('with pyautogui.hold(["win", "ctrl", "fn"]): \n\t\tpyautogui.press("f4")') #! untested
                    elif orderedMethod[realnum]['type'] == 'Next Window':
                        writeText.write('with pyautogui.hold(["win", "ctrl"]): \n\t\tpyautogui.press("right")') #! untested
                    elif orderedMethod[realnum]['type'] == 'Previous Window':
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.triggerDropDown.setItemText(2, QCoreApplication.translate("MainWindow", u"Scheduled Date", None))
        ...
        self.functionDropDown.setItemText(8, QCoreApplication.translate("MainWindow", u"New Window", None))
        self.functionDropDown.setItemText(9, QCoreApplication.translate("MainWindow", u"Close Window", None))
        self.functionDropDown.setItemText(10, QCoreApplication.translate("MainWindow", u"Next Window", None))
        self.functionDropDown.setItemText(11, QCoreApplication.translate("MainWindow", u"Previous Window", None))
        ...
        self.label_13.setText(QCoreApplication.translate("MainWindow", u"Repetitions", None))
        self.amountInput.setPlaceholderText(QCoreApplication.translate("MainWindow", u"The amount of times to press the key", None))
        ...
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("MainWindow", u"How sure the program should be (% out of 100) that the image is the one provided", None))

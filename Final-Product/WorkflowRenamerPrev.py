...
################################################################################
## Form generated from reading UI file 'WorkflowRenamereLJWTL.ui'
##
...
class Ui_MainWindow3(object):
    def setupUi(self, MainWindow):
        ...
        self.cancelButton = QPushButton(self.MainThing)
        ...
        self.workflowNameInput.setMaxLength(30)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.workflowNameInput.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Workflow name here (Max. 30 characters)", None))

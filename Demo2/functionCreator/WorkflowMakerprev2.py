...
################################################################################
## Form generated from reading UI file 'WorkflowMakerGJzvSp.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.functionDropDown = QComboBox(self.centralwidget)
        ...
        self.gridLayout.addWidget(self.functionDropDown, 4, 1, 1, 1)
        ...
        self.triggerDropDown = QComboBox(self.centralwidget)
        ...
        self.gridLayout.addWidget(self.triggerDropDown, 1, 1, 1, 1)

        self.funcSettings = QStackedWidget(self.centralwidget)
        ...
        self.gridLayout_5.addWidget(self.label_7, 0, 0, 1, 1, Qt.AlignmentFlag.AlignTop)
        ...
        self.gridLayout_5.addWidget(self.textEdit_3, 0, 1, 1, 1, Qt.AlignmentFlag.AlignTop)
        ...
        self.gridLayout.addWidget(self.funcSettings, 6, 0, 1, 2)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 646, 116))
        self.verticalLayout = QVBoxLayout(self.scrollAreaWidgetContents)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.widgetLayouts = QVBoxLayout()
        self.widgetLayouts.setObjectName(u"widgetLayouts")


        self.verticalLayout.addLayout(self.widgetLayouts)

        self.scrollArea.setWidget(self.scrollAreaWidgetContents)

        self.gridLayout.addWidget(self.scrollArea, 8, 0, 1, 2)

        self.trigSettings = QStackedWidget(self.centralwidget)
        ...
        self.gridLayout_2.addWidget(self.textEdit, 0, 1, 1, 1, Qt.AlignmentFlag.AlignTop)

        self.label_5 = QLabel(self.hotkeySettings)
        self.label_5.setObjectName(u"label_5")

        self.gridLayout_2.addWidget(self.label_5, 0, 0, 1, 1, Qt.AlignmentFlag.AlignTop)
        ...
        self.gridLayout.addWidget(self.trigSettings, 3, 0, 1, 2)

        MainWindow.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindow)

        self.funcSettings.setCurrentIndex(3)
        ...
        def AddFunction():
            ...
            self.widgetLayouts.addWidget(self.label, alignment=Qt.AlignmentFlag.AlignTop)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:700;\">Workflow Creation Idea</span></p></body></html>", None))
